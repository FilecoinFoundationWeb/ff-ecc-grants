<template>
  <component
    ...
    <div
      v-if="type !== 'X' && iconBefore"
      :class="['icon', iconBefore]">
      <IconPlay v-if="iconBefore === 'play'" />
      <IconInfo v-if="iconBefore === 'info'" />
      <IconPlus v-if="iconBefore === 'plus'" />
      <IconCode v-if="iconBefore === 'code'" />
      <IconTicket v-if="iconBefore === 'ticket'" />
    </div>
    ...
    <div
      v-if="type !== 'X' && iconAfter"
      :class="['icon', iconAfter]">
      <IconChevron v-if="iconAfter === 'chevron'" />
    </div>
